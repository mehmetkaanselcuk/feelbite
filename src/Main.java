...
public class Main {
    ...
    private static Map<String, MoodSuggestion> getMoodSuggestions() {
        ...
        map.put("tired", new MoodSuggestion("yogurt, walnuts, coffee", "orange", "Please rest for 10 minutes"));
        map.put("energetic", new MoodSuggestion("smoothie, avocado, blueberries", "red", "Transform your energy into creativity."));
        return map;
    }
}
